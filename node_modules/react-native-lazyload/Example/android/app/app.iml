...
<module external.linked.project.id=":app" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/.." external.system.id="GRADLE" external.system.module.group="reacNativeLazyload" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
