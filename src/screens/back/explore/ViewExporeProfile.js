            ...
            <ScrollView>
                ...
                <View style={styles.container}>
                {
                    ...
                    <View style={{flexDirection:'row',marginBottom:10}}>
                        ...
                        <Text style={[styles.rightText,{textTransform:'capitalize'}]}>
                        {props?.route?.params?.userDetails?.explore?.dob?calculate_age(new Date(props?.route?.params?.userDetails?.explore?.dob)):'0'} years 
                        </Text>
                    </View>
                    <View style={{flexDirection:'row',marginBottom:10}}>
                        <Text style={styles.leftText}>
                        ...
                        <Text style={[styles.rightText,{textTransform:'capitalize'}]}>
                        {props?.route?.params?.userDetails?.explore?.dob}
                        </Text>
                    </View>
                    </View>
                </View>
