    ...
    return (
        <View>
            ...
            <View style={{ marginBottom: 80 }}>
                ...
                <FlatList
                    data={search ? filterdata.concat(Posts) : null}
                    renderItem={item => {
                        if (returnTab === 'Users') {
                            // return <RenderSearchPosts item={item} searchdata={searchdata} setSearchData={setSearchData} />;

                            return <RenderSearchUsers item={item} searchdata={searchdata} setSearchData={setSearchData} />;
                            // return <RenderSearchUsers item={item} searchdata={searchdata} setSearchData={setSearchData} />;
                        }
                        else {
                            //     // return <RenderSearchUsers item={item} searchdata={searchdata} setSearchData={setSearchData} />;
